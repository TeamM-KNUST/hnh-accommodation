...
export const Overview = () =>{
  const mainTitle = "It’s easy to get started on HnH Accommodation";
  const data = [
    {
  ...
  return (
    <div className="flex flex-col gap-8 h-full  justify-between items-center px-32 ">
        ...
        {data.map(({ description, image, title }, index) => (
          <li key={title} className="flex items-start justify-start gap-6">
            ...
            <div className="relative w-48 h-32 object-cover">
              <Image src={image} alt="overview" width={720} height={720} />
            </div>
          </li>
        ))}
          </ul>
